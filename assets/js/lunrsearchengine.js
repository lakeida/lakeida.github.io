...
var documents = [{
    ...
    "body": "2020/10/18 -  He who represents himself has a fool for a client    Abraham Lincoln So I started to design and online version of my resume but realized that I was just recreating what is already available on LinkedIn. [insert LinkedIn profile link], and with more detail than my one page hard copy version i created [link to download resume here]. So instead I decided to not only create an Interactive version, but to document the process here, nothing like some good old fashion public learning and sharing to get the juices flowing. "
    }, {
    "id": 8,
