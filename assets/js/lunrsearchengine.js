...
var documents = [{
    ...
    "url": "/about",
    "title": "About",
    "body": "  Hi, I'm Lakeida Sprenkle.  Lovingly nicknamed, The DataWhisperer by my colleagues. Born and raised a cali girl, but currently calling Michigan home. This is my personal blog and what you'll find here are tidbits, quips, projects, and examples of daily wins and stumbles, that I think might be useful to others, or at least entertaining.   Although I started my career in Web Development, I quickly transitioned into Software Engineering (mostly C#, with dabbles of Ruby), but it was not long before I slowly started gravitating towards SQL. A toe dip here, writing stored procedures and views, slowly sitting down on the first step, data modeling and indexes. . . , fast forward a few years and I'm swimming in the deep end. . . , migrating data(SSIS), creating reports(SSRS), modeling and analysis(SSAS), data wrangling (Python, Power Query, R), crafting insightful visualizations (Python, Power BI, R) and more. . .    Disclaimer: This pool is just an analogy, you will not find me anywhere near the deep end, as I cannot actually swim; there's just something about not having constant access to oxygen *shivers*.   So now, 15+ years after that first, SELECT * FROM. . . I am a self-professed data addict. You can often find me frequenting public data set sites or participating in weekly and monthly viz challenges. I've listed a few of my favorite haunts in the side bar.   I love all things data. So much so, that it doesnt even feel like work anymore. Data wrangling is like playing on the swings, building visualizations is like spinning on the merry-go-round, performing advanced analytics - sliding down the. . . well you get the idea, right?   When I'm not playing with data, I enjoy photography - Still Life and Minatures (dolls, toys, figurines, etc. . . ). You can find samples of my work on Instagram (sprenkle_me), my photography site at LakeidaSprenkle. com, and unsplash. com/@lakeida   Thanks for stopping by!  Haunts:                                                                                                                                                                                                                                                                                                                                                        "
    }, {
    "id": 2,
    "url": "/categories",
    "title": "Categories",
    ...
    "body": "2019/12/01 - I’ve set out to complete all 52 weeks this year.  Ambitious for my first year I know, but I am determined to learn and grow my skills. Hoping that working with varied datasets across different industries will take me out of my comfort zone and challenge me.  Photo by Halacious on Unsplash "
    }];
